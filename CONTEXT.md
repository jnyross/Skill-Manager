...
**Suppress**:
Hiding a single plugin skill from both the model and slash commands without touching the plugin's files. The per-skill alternative to uninstalling a whole plugin.
